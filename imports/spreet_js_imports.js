...
/**
 * @param {SpriteSvg[]} files
 * @param {Options | null} [options]
 * @returns {Output}
 */
export function spreet_impl(files, options) {
    const ptr0 = passArrayJsValueToWasm0(files, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.spreet_impl(ptr0, len0, isLikeNone(options) ? 0 : addToExternrefTable0(options));
    if (ret[2]) {
...
const imports = {
    __wbindgen_placeholder__: {
        ...
        __wbg_from_2a5d3e218e67aa85: function(arg0) {
...
const wasm_url = new URL('spreet_js_imports_bg.wasm', import.meta.url);
let wasmCode = '';
